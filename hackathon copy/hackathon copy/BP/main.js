...
function call(name) {
  ...
  let clickedCalcBtn = false;
	...
	var result=$('.calc__main');
	result.hide();
	var bgfade=$('.modal-bg');
	var alpha='0.662';
	$(bgfade).css('background-color', 'rgba(0,0,0,' + alpha + ')');
...
//   closeBtn.addEventListener("click", () => (modal.style.display = "none"));
  ...
  function formSubmit(e) {
	...
	if (messages.length > 0) {
	  ...
	  var alpha='0';
	  $(bgfade).css('background-color', 'rgba(0,0,0,' + alpha + ')');
	  var pcmval=$('#name')[0].value;
	  var rankval=$('#years')[0].value;
	  var pcmentered=$('.pcmentered').text(pcmval);
	  var rankentered=$('.rankentered').text(rankval);

	  if(pcmval >=98 || rankval<20000){
			$('.highrank1').css('background-color', 'lightgreen');
			$('.lowrank1').css('background-color', 'lightgreen');
			//$('.tr11').text('7%');$('.tr12').text('12%');$('.tr13').text('2%');;
	  }
	  else if((pcmval >=95 && pcmval <98)  || (rankval>=20000 && rankval <80000)){
		
		$('.highrank1').css('background-color', 'lightgreen');
		$('.highrank3').css('background-color', 'lightgreen');
		$('.highrank2').css('background-color', 'red');
		$('.tr11').text('7%');$('.tr12').text('11%');$('.tr13').text('14%');
		$('.tr21').text('95%');$('.tr22').text('98%');$('.tr23').text('98%');
		$('.tr31').text('95%');$('.tr32').text('98%');$('.tr33').text('98%');;
		$('.tr41').text('95%');$('.tr42').text('98%');$('.tr43').text('98%');;
		$('.tr51').text('95%');$('.tr52').text('98%');$('.tr53').text('98%');;
	}
	else{
		$('.highrank1').css('background-color', 'orange');
		$('.lowrank1').css('background-color', 'red');
		$('.lastrank1').css('background-color', 'lightgreen');
		$('.tr11').text('0%');$('.tr12').text('0%');$('.tr13').text('0%');;
		$('.tr21').text('0%');$('.tr22').text('9%');$('.tr23').text('3%');;
		$('.tr31').text('15%');$('.tr32').text('5%');$('.tr33').text('7%');;
		$('.tr41').text('65%');$('.tr42').text('58%');$('.tr43').text('40%');;
		$('.tr51').text('95%');$('.tr52').text('96%');$('.tr53').text('98%');;
	}
